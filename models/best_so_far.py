...
class network(nn.Module):
    def __init__(self):
        ...
        self.d0 = nn.Sequential(
            ...
            nn.BatchNorm2d(24, 1e-05, 0.1, True, track_running_stats = True),
            nn.ReLU(),
            nn.MaxPool2d(2) 
        )
        # 4
        self.d1 = nn.Sequential(
            ...
            nn.BatchNorm2d(36, 1e-05, 0.1, True, track_running_stats = True),
            nn.ReLU(),
            nn.MaxPool2d(2)
        )
        # 2
        ...
        self.connect = nn.Sequential(
            nn.Conv2d(48, 48, 3, 1, 1),
            nn.Conv2d(48, 48, 3, 1, 1),
            nn.BatchNorm2d(48, 1e-05, 0.1, True, track_running_stats = True),
            nn.ReLU(),
        )
        ...
        self.up0 = nn.Sequential(
            nn.Conv2d(96, 36, 3, 1, 1),
            nn.Conv2d(36, 36, 3, 1, 1),
            nn.Dropout(0.6),
            nn.BatchNorm2d(36, 1e-05, 0.1, True, track_running_stats = True),
            nn.ConvTranspose2d(36, 36, 4, 2, 1),
            nn.ReLU(),
        )
        # 8
        self.up1 = nn.Sequential(
            nn.Conv2d(72, 12, 3, 1, 1),
            nn.Conv2d(12, 12, 3, 1, 1),
            nn.BatchNorm2d(12, 1e-05, 0.1, True, track_running_stats = True),
            nn.ConvTranspose2d(12, 12, 4, 2, 1),
            nn.ReLU(),
